...
public class View extends JFrame
{
    ...
    {
        return Double.parseDouble(productPriceFieldEdit.getText());
    }
    public int getProductStock()
    {
        return Integer.parseInt(productStockField.getText());
    }
    ...
    public int getNewProductStock()
    {
        return Integer.parseInt(productStockFieldEdit.getText());
    }
    ...
    {
        return Integer.parseInt(productQuantityOrderField.getText());
    }
