    ...
    public static class AdaugareNewOrderListener implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            if (quantity <= product.getStock())
            {
                ...
                int nr = Integer.parseInt(orders.get(orders.size() - 1).getOrderID());
                nr++;
                String orderID = String.valueOf(nr);
                String clientID = controller.view.getSelectedClient().getId();
                ...
                try
                {
                    ...
                    writer.write("Client: " + controller.view.getSelectedClient().getName() + "\n");
                    writer.write("Product: " + product.getName() + " " + product.getManufacture() + " Price per unit " + product.getPrice() +"\n");
                    writer.write("Quantity: " + quantity + "\n");
                    writer.write("Total Price: " + quantity * product.getPrice() + "\n");
                    writer.close();
